  ...
  return (
    <div className="pb-20 pt-36 h-screen">
      <div>
        ...
        />
        <Spotlight
          className="top-28 left-full h-[80vh] w-[50vw] "
          fill="purple"
        />
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col justify-center items-center">
          ...
          />
          <p className="text-sm my-4 text-center md:tracking-wider md:text-lg lg:text-2xl">
            Hi I&apos;m Rakib,a Next.js Developer From Bangladesh
          </p>
